...
public class TransactionsRequest {
    ...
    public TransactionsRequest(String id, Date dadd, String clid, String accid_send, String accid_recip, String type, float sum, float commission, String region, String status, String status_check) {
        this.id = id;
        this.dadd = dadd;
        this.clid = clid;
