...
public class LoginController {
    ...
    public LoginController(ClientRepository clientRepository, UserRepository userRepository) {
    ...
    public String loginUser(@Valid @RequestParam(value = "username") String username,
        ...
        ResponseEntity<String> userdata = restTemplate.postForEntity("http://localhost:8081/api/auth/signin", loginRequest, String.class);
    ...
    public String logout(HttpServletResponse response){
        RestTemplate restTemplate = new RestTemplate();
        ResponseEntity<String> logout = restTemplate.postForEntity("http://localhost:8081/api/auth/signout", null, String.class);
